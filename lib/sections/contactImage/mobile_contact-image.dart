...
import 'package:my_web_site/components_mobile/mobile_googleforms.dart';
...
class MobileContactImage extends StatelessWidget {
  const MobileContactImage({super.key});
